...
class Bank:
    def __init__(self,root):
        ...
        self.login = False
        self.root = root
        self.header = Label(self.root,text="Indian Bank",bg="blue",fg="#f5b143",font=("arial",20,"bold"))
        self.header.pack(fill=X)
        self.frame = Frame(self.root,bg="yellow",width=600,height=400)
    ...
    def MainMenu(self):#Main App Appears after logined !
        self.frame = Frame(self.root,bg="red",width=800,height=400)
